                                  ...
                                  <div class="second-box">
                                      <div class="top-box">
                                          ...
                                          <p class="availability">${
                                            property.roomNo
                                          } Beds | ${property.bathNo} Baths</p>
                                      </div>
                                      <div class="bottom-box">
                                          <a href="tel:${
                                            property.phoneNumber
                                          }" class="call-link"><i class='bx bxs-phone'></i> Call</a>
                                          <a href="${
                                            property.socialMediaHandles
                                          }" class="whatsapp-link"><i class='bx bxl-whatsapp'></i></a>
                                      </div>
                                  </div>
                              </div>
                          </div>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  [...document.querySelectorAll(".input-location-dependant")].forEach(
    (input) => {
